...
let popUpCommon = document.querySelector('.pop-up__common');
let isRenderedCall = false;

let callMe = document.querySelector('.header__call-me');
callMe.addEventListener('click', () => {

    if (isRenderedCall === true) {
        return;
    }

    isRenderedCall = true;
    popUpCommon.insertAdjacentHTML('beforebegin', call());
    ...
    function call() {
        return `
            <div class="pop-up">
                ...
                <div class="pop-up__age">
                    <p>Your Age</p>
                    <div class="pop-up__inout-block">
                        <label>10 - 20 <input type="radio"></label>
                        <label>20 - 30 <input type="radio"></label>
                        <label>30 - 40 <input type="radio"></label>
                    </div>
                </div>
    
                <div class="pop-up__button-comon">
                    <button class="pop-up__download">
                        <p>Download your photo:</p>
                        <img src="../../www/img/Vector-down.png" alt="">
                    </button>
    
                    <button class="pop-up__send">Send</button>
                </div>
            </div>
        `;
    }
